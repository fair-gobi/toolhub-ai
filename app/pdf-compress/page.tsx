export const metadata = {
  title: "PDF Compressor - Free Online Tool | ToolHub Nepal",
  description: "Reduce PDF file size online. Fast, free, no signup required. Made in Nepal.",
};
  ...
  return (
    <main className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-2xl mx-auto bg-white rounded-xl shadow p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">Reduce PDF file size online</p>
