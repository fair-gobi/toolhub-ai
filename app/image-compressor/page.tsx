export const metadata = {
  title: "Image Compressor - Free Online Tool | ToolHub Nepal",
  description: "Compress JPG PNG WebP online free. Fast, free, no signup required. Made in Nepal.",
};
  ...
  return (
    <main className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-2xl mx-auto bg-white rounded-xl shadow p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">Compress JPG PNG WebP online free</p>
